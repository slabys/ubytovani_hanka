...
>
    ...
    @if($hero['image'])
        ...
        ></div>
        <div class="absolute inset-0 bg-[#1c1a14]/60"></div>
    @else
        <div class="absolute inset-0 bg-gradient-to-b from-[#2a1f0e] via-[#1c1a14] to-[#1c1a14]"></div>
    @endif
    ...
    <div class="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        @if($hero['cta_label'])
            <a
                ...
                class="inline-flex items-center gap-3 font-['DM_Sans'] text-sm font-light tracking-[0.2em] uppercase text-[#1c1a14] bg-[#c9a96e] px-8 py-4 hover:bg-[#f5f0e8] transition-colors duration-300"
            >
                {{ $hero['cta_label'] }}
